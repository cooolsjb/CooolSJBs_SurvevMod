                    ...
                    <div id="news-wrapper">
                        ...
                        <div id="news-block" class="menu-block">
                            <div id="news">
                                ...
                                <div id="news-current" data-date="2026-06-19">
                                ...
                                <div data-date="2025-10-21">
                                    ...
                                    <p class="news-paragraph">
                                        A strange irregularity emanating from the center of the island has led to the
                                        temporal displacement of survevrs back to <span class="highlight"
                                        >October 2017</span>... perfectly coinciding with <span class="highlight"
                                        >surviv's birthday!</span>
                                    </p>
                                    <p class="news-paragraph">
                                        Celebrate eight years of chicken dinners with a new limited-time gamemode
                                        simulating the Early Access version of the game, featuring <span
                                            class="highlight"
                                        >silos, boxes, trees...</span> and the key to victory: <span class="highlight"
                                        >weapons</span>! Note that our lack of research funds back then also means that
                                        the <span class="highlight">barrels don't explode.</span>
                                    </p>
                                    <p class="news-paragraph">
                                        On top of that, a new and improved <span class="highlight">fall map</span> has
                                        returned, with additional obstacles and a <span class="highlight"
                                        >new type of squash</span>, providing even more loot for you.
                                    </p>
                                    <p class="news-paragraph">
                                        Thanks to everyone for being a part of this community, and go hunting for the
                                        chicken dinner! Beware of the approaching gloom...
                                    </p>
                                </div>
                            </div>
                        </div>
